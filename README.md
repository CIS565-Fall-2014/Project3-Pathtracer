...
Also I find that the randseed for BSDF input has a hugh impact for the result. Here is a interesting picture generated by the same code except different randSeed which is actually pretty cool!
