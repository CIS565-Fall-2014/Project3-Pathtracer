...
Also I find that the randseed for BSDF input has a hugh impact for the result. Here are some interesting pictures generated by the same code except different randSeed:
