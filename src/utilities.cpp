...
glm::mat4 utilityCore::buildTransformationMatrix(glm::vec3 translation, glm::vec3 rotation, glm::vec3 scale){
  ...
  glm::mat4 rotationMat = glm::rotate(glm::mat4(), rotation.x / 180 * (float)PI, glm::vec3(1,0,0));
  rotationMat = rotationMat*glm::rotate(glm::mat4(), rotation.y / 180 * (float)PI, glm::vec3(0,1,0));
  rotationMat = rotationMat*glm::rotate(glm::mat4(), rotation.z / 180 * (float)PI, glm::vec3(0,0,1));
