...
glm::mat4 utilityCore::buildTransformationMatrix(glm::vec3 translation, glm::vec3 rotation, glm::vec3 scale){
  ...
  float tx = rotation.x / (float)180 * PI;
  float ty = rotation.y / (float)180 * PI;
  float tz = rotation.z / (float)180 * PI;
  glm::mat4 rotationMat = glm::rotate(glm::mat4(), tx, glm::vec3(1,0,0));
  rotationMat = rotationMat*glm::rotate(glm::mat4(), ty, glm::vec3(0,1,0));
  rotationMat = rotationMat*glm::rotate(glm::mat4(), tz, glm::vec3(0,0,1));
